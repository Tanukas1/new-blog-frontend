...
const BlogDetail = props => {
    ...
    return (
        <Card>
            <CardMedia image={url + props.blogData.thumbnail} style={{ height: '18rem' }}>
            ...
            <CardContent>
                ...
                <Button component={Link} to={'/viewblog/' + props.blogData._id} variant="contained" className="mt-2" color="primary">View More</Button>
            </CardContent>
        </Card>
    )
}
